...
function save() {
	$('#courierTaskForm').form('submit',{
		url : '${pageContext.request.contextPath}/personnel/courierInfo/ClogisticsInfoUpdate.action',
		success : function(d) {
			json = $.parseJSON(d);
			if (json.success) {
...
<div style="padding-left:70px;padding-right: 70px;padding-top: 20px;padding-bottom: 20px;">
	<form  id="courierTaskForm" method="post">		
		<div style="margin-bottom: 5px">
			...
			url:'${pageContext.request.contextPath}/personnel/courierInfo/ClogisticsIdCombobox.action'" />
		</div>
		<div style="margin-bottom: 5px">
