		...
		<form id="driverTaskForm" method="post">
			...
			<div style="margin-bottom: 5px">
				配送人员：<input id="driverId" name="driverId" class="easyui-combobox"
					style="width: 75%; height: 30px; padding: 12px;"
					data-options="valueField:'driverId',editable:false,textField:'driverName',panelHeight:120,
			...
			<div style="margin-bottom: 5px">
				配送任务：<input id="driverTask" type="text" name="driverTask"
					data-options="required:true,prompt:'请输入任务详情'"
					class="easyui-textbox"
					style="width: 75%; height: 30px; padding: 12px">
			</div>
			<div style="text-align: center;">
				<a id="btn" onclick="save()" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'">添加任务</a>
			</div>
		</form>
	</div>
</body>
